define([
	...
	'css!/css/ui/PaletteView.css'
		...
		return Backbone.View.extend({
			...
			colors: [{"name":"$gray1","color":"#eff2ec"},{"name":"$gray2","color":"#eeeded"},{"name":"$gray2_3","color":"#e3e3e3"},{"name":"$gray3","color":"#999999"},{"name":"$gray6","color":"#333"},{"name":"$purple2","color":"#6563a4"},{"name":"$purple3","color":"#5f5d9a"},{"name":"$purple4","color":"#7a4364"},{"name":"$pink2","color":"#d667cd"},{"name":"$green2","color":"#6dd5c9"},{"name":"$blue3","color":"#00bcd4"}],
			_base: null,
			initialize: function(){
				var that = this;
